        ...
        <div className="w-full max-w-md mt-12 md:mt-0">
          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-4" onSubmit={handleRegister}>
              ...
              <div>
                ...
                <GlassInputWrapper>
                  <div className="relative">
                    <input name="password" type={showPassword ? 'text' : 'password'} placeholder="Créez un mot de passe" className="w-full bg-transparent text-[#02073E] text-sm p-3.5 pr-12 rounded-2xl focus:outline-none" required />
              ...
              <button type="submit" className="w-full rounded-2xl bg-[#357dab] py-4 font-bold text-white hover:bg-[#02073E] hover:shadow-lg transition-all duration-300 mt-2">
                Créer un compte
              </button>
            </form>
      ...
      <section className="hidden md:flex flex-1 relative p-4 bg-gray-50">
        <div className="relative w-full h-full rounded-[2rem] overflow-hidden shadow-2xl">
          ...
          <div 
            ...
            style={{ backgroundImage: `url('/header_photo/h2.avif')` }}
          ></div>
