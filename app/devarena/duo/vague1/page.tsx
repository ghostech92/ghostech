...
export default function Vague1Page() {
  const { sortedDuos, waveStatus, isLocked } = useWaveDuos("vague1");
  ...
  return (
    <div className="w-full min-h-screen bg-white text-gray-950 font-sans flex justify-center pb-20">
      <main className="p-4 lg:p-8 space-y-8 max-w-[1000px] w-full mx-auto pt-20">
        ...
        <section className="bg-[#EC4899] border-b-[6px] border-[#BE185D] rounded-3xl p-6 lg:p-8 text-white relative overflow-hidden shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-3 max-w-xl text-center md:text-left">
            ...
            <p className="text-xs font-bold opacity-90 leading-relaxed">
              Découvrez les duos de la première vague de l'arène. Ces équipes ont eu 1 semaine to développer leur MVP et ont été évaluées selon les critères officiels.
            </p>
          </div>
        ...
        {/* WAVE STATUS BANNER */}
        {waveStatus === "Terminée" && (
          <div className="bg-[#FDF2F8] border-2 border-[#FBCFE8] rounded-3xl p-5 flex items-center gap-4 text-gray-950">
            <span className="text-3xl">🏁</span>
            <div>
              <h4 className="font-black text-sm uppercase tracking-tight text-[#DB2777]">Vague Terminée</h4>
