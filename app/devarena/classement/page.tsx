...
export default function ClassementPage() {
  const { leaderboard, allWaves, allFinished, loading } = useLeaderboard();
    ...
    <div className="w-full min-h-screen bg-white text-gray-950 font-sans flex justify-center pb-20">
      <main className="p-4 lg:p-8 space-y-8 max-w-[1000px] w-full mx-auto pt-20">
        ...
        <LeaderboardHero 
          ...
          description="Découvrez les meilleurs duos et développeurs de la Ghostech Arena. Cumulez des points en développant vos MVPs et en remportant les vagues du tournoi." 
        />

        {/* LIST */}
        <section className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <h3 className="text-xs font-black text-gray-400 tracking-wider uppercase">Saison Actuelle</h3>
            <WaveNavigation currentWave="global" allWaves={allWaves} />
          </div>
