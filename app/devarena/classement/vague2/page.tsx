...
export default function Vague2Classement() {
  const { leaderboard, allWaves, allFinished, loading } = useLeaderboard("vague2");
  ...
  return (
    <div className="w-full min-h-screen bg-white text-gray-950 font-sans flex justify-center pb-20">
      <main className="p-4 lg:p-8 space-y-8 max-w-[1000px] w-full mx-auto pt-20">
        ...
        <LeaderboardHero 
          top1={top1} 
          title="Classement Vague 2" 
          description="Classement spécifique à la deuxième vague de la DevArena." 
        />

        {/* LIST */}
        <section className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <h3 className="text-xs font-black text-gray-400 tracking-wider uppercase">Vague 2</h3>
            <WaveNavigation currentWave="vague2" allWaves={allWaves} />
          </div>
